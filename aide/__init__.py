...
class Experiment:
    ...
    def __init__(self, data_dir: str, goal: str, eval: str | None = None, node_path: str | None = None):
        ...
        Args:
            ...
            node_path (str | None, optional): Path to the directory where the agent workspace will be created. Defaults to None.
        """
